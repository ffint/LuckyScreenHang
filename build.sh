...
clang --target=aarch64-linux-android29 -Os -fPIC -ffreestanding -fno-builtin -fno-stack-protector -fvisibility=hidden -c "$ROOT/src/luckyhang.c" -o "$B/luckyhang.o"
...
python3 "$ROOT/src/sign_apk_v2.py" "$B/LuckyScreenHangLite-unsigned.apk" "$B/LuckyScreenHang-Android17-v1.3.2.apk" "$ROOT/signing/lucky-signing-key.pem" "$ROOT/signing/lucky-signing-cert.pem"
sha256sum "$B/LuckyScreenHang-Android17-v1.3.2.apk" > "$B/SHA256.txt"
echo "Built: $B/LuckyScreenHang-Android17-v1.3.2.apk"
